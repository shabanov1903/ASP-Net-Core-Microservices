...
{
    public class DB_DotNet : MetricsManager.DAL.IDotNetMetricsRepository
    {
        public List<DotNetMetrics> GetByTimePeriod()
        {
            // создаем массив, в который запишем объекты с данными из базы
            // данных
            var returnArray = new List<DotNetMetrics>();
            ...
            using (var connection = new SQLiteConnection(connectionString))
            {
                ...
                using (var command = new SQLiteCommand(connection))
                {
                    ...
                    string readQuery = "SELECT * FROM dotnetmetrics";
                    ...
                    using (SQLiteDataReader reader = command.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            returnArray.Add(new DotNetMetrics()
                            {
