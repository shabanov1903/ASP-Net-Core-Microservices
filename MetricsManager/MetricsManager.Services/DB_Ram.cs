...
{
    public class DB_Ram : MetricsManager.DAL.IRamMetricsRepository
    {
        public List<RamMetrics> GetByTimePeriod()
        {
            // создаем массив, в который запишем объекты с данными из базы
            // данных
            var returnArray = new List<RamMetrics>();
            ...
            using (var connection = new SQLiteConnection(connectionString))
            {
                ...
                using (var command = new SQLiteCommand(connection))
                {
                    ...
                    string readQuery = "SELECT * FROM rammetrics";
                    ...
                    using (SQLiteDataReader reader = command.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            returnArray.Add(new RamMetrics()
                            {
